...
namespace Helm_Budget_System.Pages.ExpenseCategories
{
    ...
    public class DeleteModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(int? id, bool? saveChangesError = false)
        {
            ...
            ExpenseCategory = await _context.ExpenseCategory.Include(s => s.School).AsNoTracking().FirstOrDefaultAsync(m => m.ID == id);
        ...
        public async Task<IActionResult> OnPostAsync(int? id)
        {
            ...
            var school = await _context.ExpenseCategory.FindAsync(id);
            ...
            try
            {
                _context.ExpenseCategory.Remove(school);
