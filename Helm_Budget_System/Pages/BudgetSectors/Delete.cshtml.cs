...
namespace Helm_Budget_System.Pages.BudgetSectors
{
    ...
    public class DeleteModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(int? id, bool? saveChangesError = false)
        {
            ...
            BudgetSector = await _context.BudgetSector.Include(s => s.School).AsNoTracking().FirstOrDefaultAsync(m => m.ID == id);
        ...
        public async Task<IActionResult> OnPostAsync(int? id)
        {
            ...
            var school = await _context.BudgetSector.FindAsync(id);
            ...
            try
            {
                _context.BudgetSector.Remove(school);
