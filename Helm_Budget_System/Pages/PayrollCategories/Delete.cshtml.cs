...
namespace Helm_Budget_System.Pages.PayrollCategories
{
    ...
    public class DeleteModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(int? id, bool? saveChangesError = false)
        {
            ...
            PayrollCategory = await _context.PayrollCategory.Include(s => s.School).AsNoTracking().FirstOrDefaultAsync(m => m.ID == id);
        ...
        public async Task<IActionResult> OnPostAsync(int? id)
        {
            ...
            var school = await _context.PayrollCategory.FindAsync(id);
            ...
            try
            {
                _context.PayrollCategory.Remove(school);
